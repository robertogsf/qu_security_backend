...
class Property(models.Model):
    ...
    total_hours = models.PositiveIntegerField(default=0, validators=[MinValueValidator(0)])
...
class Shift(models.Model):
    ...
    hours_worked = models.PositiveIntegerField(default=0, validators=[MinValueValidator(0)])
