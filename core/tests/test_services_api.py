...
class TestServiceAPI:
    ...
    def test_create_service_as_admin(self, api_client, admin_user, guard_instance, property_instance):
    ...
    def test_create_service_as_client_forbidden(self, api_client, client_user, guard_instance, property_instance):
    ...
    def test_services_by_property(self, api_client, admin_user, service_instance):
        ...
        response = api_client.get(url, {"property_id": service_instance.assigned_property.id})
...
class TestServiceValidation:
    ...
    def test_negative_monthly_budget_validation(self, guard_instance, property_instance):
...
class TestServicePermissions:
    ...
    def test_admin_full_access(self, api_client, admin_user, service_instance):
        ...
        # Retrieve
        response = api_client.get(reverse("core:service-detail", kwargs={"pk": service_instance.id}))
        assert response.status_code == 200
    ...
    def test_guard_limited_access(self, api_client, guard_user, service_instance):
        ...
        response = api_client.get(reverse("core:service-detail", kwargs={"pk": service_instance.id}))
        assert response.status_code in [200, 403]  # Depends on permission implementation
    ...
    def test_client_limited_access(self, api_client, client_user, service_instance):
        ...
        response = api_client.post(reverse("core:service-list"), {
            "name": "Test Service",
            "rate": "25.00",
            "monthly_budget": "2000.00"
        })
